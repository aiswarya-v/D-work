...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x66666666, 0x7777, 0x8888, {0x99, 0x99, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ConsumerDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPciProtocolGuid = { 0x12345678, 0x1234, 0x5678, {0x11,0x22,0x33,0x44,0x55,0x66,0x77,0x88} };
...
{
  return PciConsumerEntry (ImageHandle, SystemTable);
}
