...
#define STACK_COOKIE_VALUE 0x6BF910349C9726D0ULL
...
#define _PCD_TOKEN_PcdSataDeviceReadyTimeout  0U
#define _PCD_SIZE_PcdSataDeviceReadyTimeout 1
#define _PCD_GET_MODE_SIZE_PcdSataDeviceReadyTimeout  _PCD_SIZE_PcdSataDeviceReadyTimeout 
#define _PCD_VALUE_PcdSataDeviceReadyTimeout  16U
extern const  UINT8  _gPcd_FixedAtBuild_PcdSataDeviceReadyTimeout;
#define _PCD_GET_MODE_8_PcdSataDeviceReadyTimeout  _gPcd_FixedAtBuild_PcdSataDeviceReadyTimeout
//#define _PCD_SET_MODE_8_PcdSataDeviceReadyTimeout  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD
