...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiIgvmDataHobGuid = {0x3dd177ff, 0xb632, 0x4e25, {0xbe, 0xf3, 0x06, 0x50, 0x63, 0xd5, 0x5f, 0xc4}};
...
#define _PCD_VALUE_PcdOvmfSecValidatedStart  8585216U
...
#define _PCD_VALUE_PcdOvmfEarlyMemDebugLogBase  0x00820000U
...
#define _PCD_TOKEN_PcdOvmfIgvmParamBase  0U
#define _PCD_SIZE_PcdOvmfIgvmParamBase 4
#define _PCD_GET_MODE_SIZE_PcdOvmfIgvmParamBase  _PCD_SIZE_PcdOvmfIgvmParamBase 
#define _PCD_VALUE_PcdOvmfIgvmParamBase  0x00812000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdOvmfIgvmParamBase = _PCD_VALUE_PcdOvmfIgvmParamBase;
extern const  UINT32  _gPcd_FixedAtBuild_PcdOvmfIgvmParamBase;
#define _PCD_GET_MODE_32_PcdOvmfIgvmParamBase  _gPcd_FixedAtBuild_PcdOvmfIgvmParamBase
//#define _PCD_SET_MODE_32_PcdOvmfIgvmParamBase  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD

#define _PCD_TOKEN_PcdOvmfIgvmParamSize  0U
#define _PCD_SIZE_PcdOvmfIgvmParamSize 4
#define _PCD_GET_MODE_SIZE_PcdOvmfIgvmParamSize  _PCD_SIZE_PcdOvmfIgvmParamSize 
#define _PCD_VALUE_PcdOvmfIgvmParamSize  0x00001000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdOvmfIgvmParamSize = _PCD_VALUE_PcdOvmfIgvmParamSize;
extern const  UINT32  _gPcd_FixedAtBuild_PcdOvmfIgvmParamSize;
#define _PCD_GET_MODE_32_PcdOvmfIgvmParamSize  _gPcd_FixedAtBuild_PcdOvmfIgvmParamSize
//#define _PCD_SET_MODE_32_PcdOvmfIgvmParamSize  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD

#define _PCD_TOKEN_PcdOvmfIgvmHobBase  0U
#define _PCD_SIZE_PcdOvmfIgvmHobBase 4
#define _PCD_GET_MODE_SIZE_PcdOvmfIgvmHobBase  _PCD_SIZE_PcdOvmfIgvmHobBase 
#define _PCD_VALUE_PcdOvmfIgvmHobBase  0x00813000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdOvmfIgvmHobBase = _PCD_VALUE_PcdOvmfIgvmHobBase;
extern const  UINT32  _gPcd_FixedAtBuild_PcdOvmfIgvmHobBase;
#define _PCD_GET_MODE_32_PcdOvmfIgvmHobBase  _gPcd_FixedAtBuild_PcdOvmfIgvmHobBase
//#define _PCD_SET_MODE_32_PcdOvmfIgvmHobBase  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD

#define _PCD_TOKEN_PcdOvmfIgvmHobSize  0U
#define _PCD_SIZE_PcdOvmfIgvmHobSize 4
#define _PCD_GET_MODE_SIZE_PcdOvmfIgvmHobSize  _PCD_SIZE_PcdOvmfIgvmHobSize 
#define _PCD_VALUE_PcdOvmfIgvmHobSize  0x00001000U
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdOvmfIgvmHobSize = _PCD_VALUE_PcdOvmfIgvmHobSize;
extern const  UINT32  _gPcd_FixedAtBuild_PcdOvmfIgvmHobSize;
#define _PCD_GET_MODE_32_PcdOvmfIgvmHobSize  _gPcd_FixedAtBuild_PcdOvmfIgvmHobSize
//#define _PCD_SET_MODE_32_PcdOvmfIgvmHobSize  ASSERT(FALSE)  // It is not allowed to set value for a FIXED_AT_BUILD PCD
