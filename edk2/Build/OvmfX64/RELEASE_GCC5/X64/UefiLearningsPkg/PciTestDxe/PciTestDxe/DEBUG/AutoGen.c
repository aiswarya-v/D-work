...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xA1B2C3D4, 0xE5F6, 0x47A8, {0x91, 0xB2, 0xC3, 0xD4, 0xE5, 0xF6, 0x78, 0x90}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PciTestDxe";
...
{
  return PciTestEntry (ImageHandle, SystemTable);
}
