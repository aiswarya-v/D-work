...
%ifdef ARCH_X64
  ...
  %define IGVM_PARAM_START          (FixedPcdGet32 (PcdOvmfIgvmParamBase))
  %define IGVM_PARAM_SIZE           (FixedPcdGet32 (PcdOvmfIgvmParamSize))

  %define IGVM_HOB_START            (FixedPcdGet32 (PcdOvmfIgvmHobBase))
  %define IGVM_HOB_SIZE             (FixedPcdGet32 (PcdOvmfIgvmHobSize))
